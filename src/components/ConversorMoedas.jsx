...
useEffect(() => {
    fetch('http://api.exchangeratesapi.io/v1/latest?access_key=54e5f91133b167d2525e2fe723a41461&format=1')
...
const converterMoeda = () => {
    fetch(`http://api.exchangeratesapi.io/v1/latest?access_key=54e5f91133b167d2525e2fe723a41461&format=1base=${deMoeda}&symbols=${paraMoeda}`)
    .then(response => response.json())
    .then(data => {
